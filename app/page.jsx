  ...
  return (
     <div className='mx-auto bg-hero-mesh3'>
      <div className='flex flex-col mb-4 ml-4 md:mb-0 md:ml-0 py-10 md:py-2'>
        <h1 className='text-left text-5xl sm:text-7xl md:text-[12.125rem] md:leading-[0.8] md:text-center font-black text-verde uppercase'>Ivan Nevares</h1>
        <h2 className='text-left text-5xl sm:text-7xl md:text-[11.5rem] md:leading-[0.8] font-offBitBold md:text-center text-verde uppercase'>Digital Designer</h2>
      </div>
      ...
      <div className='grid md:grid-cols-2 mx-1 my-8 '>
        ...
        <div className='flex justify-between ml-4 sm:ml-0 my-10 sm:my-0 items-center'>
